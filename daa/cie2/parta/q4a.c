#include <stdio.h>
// prove f(n) = 5n^2 + 6n + 3 is theta(n^2) by finding c1=5, c2=14, n0=1 where c1*n^2 <= f(n) <= c2*n^2 for n >= n0
...
int main() {
    ...
    for (int n = 10; n <= 30; n++) {
        long long fn = 5LL * n * n + 6 * n + 3, c1n2 = (long long)c1 * n * n, c2n2 = (long long)c2 * n * n;
